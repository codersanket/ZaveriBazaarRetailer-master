...
import 'package:sonaar_retailer/pages/follows/follow_wholesaler_view.dart';
  ...
  Widget _buildListView() {
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final accepted = _follows[index].accepted;
          ...
          child: ListTile(
            ...
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (_) => FollowWholesalerViewPage(
                    heroTag: heroTag,
                    followId: _follows[index].id,
                  ),
                ),
              );
            },
            ...
            // Followed details
            title: Text(
                "${followed.name[0].toUpperCase()}${followed.name.substring(1)}"),
            subtitle: followed.mobile == null ? null : Text(followed.mobile),
